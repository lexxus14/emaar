 ...
 <script type="text/javascript">
    $(document).ready(function(){     
        ...
        function GetBillData(Id) { 
            ...
            $.get('{{route('SApiTypeInfo')}}' + '/' + Id, function (data) {
                //success data
                console.log(data);
        ...
        function execute(Id,apihost,apikey,leasecode,unitno,sched) {
            ...
            var y = newdate.getFullYear();            
            var formattedDate =  y + '-' + mm + '-' + dd;
            $.get('{{route('SBillReport')}}' + '/' + Id, function (data) {
                console.log(data);
                    if(data.length <= 0 ){
                ...
                "SalesInfo": [
                  {
                    "UnitNo":  unitno,
                    "LeaseCode": leasecode,
                    "SalesDateFrom": '<?php  echo $dateFrom; ?>',
                    "SalesDateTo": '<?php echo $dateTo; ?>',
                    "TransactionCount": totalTransaction,
                    "TotalSales": total,
                    "Remarks": '<?php echo $dateFrom.' '.$dateTo; ?>'
                  }
                ]
              }
            }),
