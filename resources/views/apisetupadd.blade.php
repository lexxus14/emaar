...
<div class="container">
    <div class="row">
        ...
        @if ($errors->any())
          ...
          @endif
        <form  action="{{route('apisetupstore')}}" method="Post" enctype="multipart/form-data" class="needs-validation add-product-form" novalidate="">
            <input type="hidden" name ="_token" value="{!! csrf_token() !!}">
        <div class="row">
            <div class="col-md-6">
                <input type="text" class="form-control has-error" name="code" placeholder="Code" value="">
            </div>             
        </div>   
        <div class="row">
            <div class="col-md-6">
                <input type="text" class="form-control has-error"  name="apiname" placeholder="API Name" value="">
            </div> 
        ...
        <div class="row">
            <div class="col-md-6">
                <input type="text" class="form-control has-error"  name="apihost" placeholder="API Post" value="">
            </div> 
            <div class="col-md-6">
                <input type="text" class="form-control has-error"  name="apikey" placeholder="API Key" value="">
            </div>             
        </div>
        <div class="row">
            <div class="col-md-6">
                <input type="text" class="form-control has-error"  name="unitno" placeholder="Unit No" value="">
            </div> 
            <div class="col-md-6">
                <input type="text" class="form-control has-error"  name="leasecode" placeholder="Lease Code" value="">
            </div>             
        </div>
        <br>
        <div class="row">
        ...
        <div class="row">
              <div class='col-sm-4'>
                 From:<input type='date' class="form-control" name ="startdate" />
              </div>
              <div class='col-sm-4'>
                 To:<input type='date' class="form-control" name="enddate" />
              </div>       
            <div class="col-sm-4">
